...
function processRequest(request, response) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (request.body.event === event_type_enum_1.EEventType.message) {
            const body = request.body;
            if (body.message.text === "2") {
                (0, send_message_to_viber_util_1.sendMessage)({
                    receiver: body.sender.id,
                    text: "Привіт Юля. Я твій віртуальний коханець. Давай дружити 222",
                    min_api_version: 7,
                    type: message_type_enum_1.EMessageType.text,
                    keyboard: {
                        Type: "keyboard",
                        DefaultHeight: false,
                        Buttons: [
                    ...
                    rich_media: {
                        ...
                        Buttons: [
                            ...
                            //   },
                            {
                                Columns: 6,
                                Rows: 6,
                                Text: `<font color=#323232><b>${title}</b></font><font color=#777777><br></font><font color=#6fc133></font>` +
                                    html,
                                ActionType: "open-url",
                                ActionBody: "https://www.google.com",
                                TextSize: "medium",
        ...
        if (request.body.event === event_type_enum_1.EEventType.conversation_started) {
            const body = request.body;
            (0, send_message_to_viber_util_1.sendTextMessageToViber)({
